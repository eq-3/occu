...
set PROFILE_1(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck wird der Gong eingeschaltet. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so wird er erst nach Ablauf dieser Zeit eingeschaltet."
