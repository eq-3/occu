...
set PROFILE_1(SHORT_ON_TIME)		{1200 range 0.0 - 111600.0}
...
set PROFILE_1(SHORT_JT_ON) 			{1 2}
set PROFILE_1(SHORT_JT_OFFDELAY)	{1 2}
set PROFILE_1(SHORT_JT_ONDELAY)		{1 2}
set PROFILE_1(UI_DESCRIPTION)	"Bei erh&ouml;htem CO2-Gehalt der Luft wird der Schalter f&uuml;r die eingestellte Zeit eingeschaltet."
...
#1
	...
	append HTML_PARAMS(separate_$prn)	"<tr><td>\${ON_THRESHOLD}</td><td>"	
	array_clear options
