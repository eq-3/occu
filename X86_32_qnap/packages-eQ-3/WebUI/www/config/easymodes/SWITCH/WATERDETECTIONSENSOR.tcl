...
source [file join $env(DOCUMENT_ROOT) config/easymodes/SWITCH/mapping/WATERDETECTIONSENSOR_map.tcl]
...
set PROFILE_1(UI_DEFINITION_1_1)	"schon bei leichter Feuchtigkeit"
set PROFILE_1(UI_DEFINITION_1_2)	"erst ab 1.5mm Wasserstand"
set PROFILE_1(UI_DESCRIPTION)	"Bei Feuchte wird der Schalter f&uuml;r die eingestellte Zeit eingeschaltet. Die Schaltzuordnung l&auml;sst sich auch umkehren."
...
set PROFILE_2(UI_DESCRIPTION)	"Bei &Auml;nderung der Feuchtigkeit wird der Schalter f&uuml;r die eingestellte Zeit eingeschaltet."
...
#2
	...
	append HTML_PARAMS(separate_$prn) "</table></textarea></span>"	
