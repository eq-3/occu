...
set PROFILE_1(SHORT_ON_TIME)		{111600 300 6}
...
set PROFILE_1(UI_DESCRIPTION)	"Beim Ausl&ouml;sen des Sensors wird die Signalleuchte des Gongs eingeschaltet. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so wird die LED erst nach Ablauf dieser Zeit eingeschaltet."
