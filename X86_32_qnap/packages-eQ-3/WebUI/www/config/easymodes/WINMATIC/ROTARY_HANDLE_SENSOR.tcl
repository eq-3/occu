...
set PROFILES_MAP(1) "\${window_tilt_close}"
...
set PROFILE_1(UI_DESCRIPTION)		"x"
set PROFILE_1(UI_TEMPLATE)			"template x"
...
set PROFILE_2(UI_DESCRIPTION)		"y"
set PROFILE_2(UI_TEMPLATE)			"template y"
