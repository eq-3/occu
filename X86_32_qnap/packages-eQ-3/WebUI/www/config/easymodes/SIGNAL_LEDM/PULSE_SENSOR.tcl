...
#	die Texte der Platzhalter einlesen
	puts "<script type=\"text/javascript\">getLangInfo('$dev_descr_sender(TYPE)', '$dev_descr_receiver(TYPE)M');</script>"
	set prn 0	
...
#1
	...
	# Signalart
	source [file join $env(DOCUMENT_ROOT) config/easymodes/SIGNAL_LEDM/signal_type.tcl]
