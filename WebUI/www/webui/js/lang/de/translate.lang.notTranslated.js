jQuery.extend(true,langJSON, {
  "de" : {
    ...
    "stringTablePassageDetectorCounterTransmitterCondTxCondTXDecisionAbove" : "* COND_TX_DECISION_ABOVE",
    "stringTablePassageDetectorCounterTransmitterCondTxCondTXDecisionBelow" : "* COND_TX_DECISION_BELOW",
    "stringTablePassageDetectorCounterTransmitterCondTxThresholdHi" : "* COND_TX_THRESHOLD_HI",
    "stringTablePassageDetectorCounterTransmitterCondTxThresholdLo" : "* COND_TX_THRESHOLD_LO",
    ...
    "COMMENT" : "TODO NEW, add this to en and tr",
    ...
    "stringTableWeekProgramTargetChannelLockManu" : "Modus Wochenprogramm: Manuell",
    "stringTableWeekProgramTargetChannelLockAutoReset" : "Modus Wochenprogramm: Auto mit Reset (Reset ohne Funktion)",
    "stringTableWeekProgramTargetChannelLockAuto" : "Modus Wochenprogramm: Auto ohne Reset",
    ...
    "optionReGaNORMAL" : "NORMAL",
    "optionReGaLEGACY" : "LEGACY",
    "optionReGaCOMMUNITY" : "COMMUNITY",

    "dialogRestart2ChanceReGaVersion" :
      "Damit die %C4nderung der Logikschicht-Version wirksam wird, muss die " + HMIdentifier.de.CCUShortName + " neu gestartet werden.",
