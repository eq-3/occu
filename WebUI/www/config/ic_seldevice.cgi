...
#cgi_debug -on
  ...
  puts "<div id=\"ic_selchannel\">"
    ...
    puts "<div id=\"id_body\">"
      ...
      puts "  s += \"<tr>\";"
      if {$step < 3} then {
        puts "  s += \"<td style='text-align:center; vertical-align:middle;'><div class='FooterButton' onclick='WebUI.enter(NewDeviceListPage);'>\${btnCancel}</div></td>\";"
...
proc put_tableheader {} {
  ...
  puts "<TR>"
  puts "<TD class=\"chnListTbl_Caption\" style=\"text-align:left;\" colspan=\"10\">\${replaceDeviceTblHeader}</TD>"
  puts "</TR>"
...
#cgi_debug -on
  ...
  if {$rowcount == 0} then {
    puts "<TR>"
    puts "<TD height=\"100\"  style=\"text-align:center;\" COLSPAN=\"10\">\${replaceDeviceNoDevAvailable}</TD>"
    puts "</TR>"
  }
