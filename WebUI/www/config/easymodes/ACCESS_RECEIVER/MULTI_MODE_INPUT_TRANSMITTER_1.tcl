...
set PROFILE_2(LONG_JT_OFF) $RAMP_ON
set PROFILE_2(LONG_JT_ON) $RAMP_ON
set PROFILE_2(LONG_PROFILE_ACTION_TYPE) 1
set PROFILE_2(LONG_WP_OPTIONS) 0
...
set PROFILE_2(SHORT_WP_OPTIONS) {0 1 2}
...
set PROFILE_3(LONG_JT_OFF) $RAMP_OFF
set PROFILE_3(LONG_JT_ON) $RAMP_OFF
set PROFILE_3(LONG_PROFILE_ACTION_TYPE) 1
set PROFILE_3(LONG_WP_OPTIONS) 0
...
set PROFILE_3(SHORT_WP_OPTIONS) {0 1 2}
...
set PROFILE_4(LONG_JT_OFF) $OPEN
set PROFILE_4(LONG_JT_ON) $OPEN
set PROFILE_4(LONG_PROFILE_ACTION_TYPE) 1
set PROFILE_4(LONG_WP_OPTIONS) 0
...
set PROFILE_4(SHORT_WP_OPTIONS) {0 1 2}
...
set comment { // Currently the HmIP-DLD doesn't support this
  append HTML_PARAMS(separate_$prn) "<tr><td>\${lblWeeklyProgram}</td><td>"
  array_clear options
