...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
  ...
  incr prn
  set param BAUDRATE
  append HTML_PARAMS(separate_1) "<tr class=\"j_IECSensor hidden\">"
    array_clear options
  ...
  append HTML_PARAMS(separate_1) "<tr class=\"j_IECSensor hidden\">"
    ...
    append HTML_PARAMS(separate_1) "<td>[getComboBox options $prn '$param' $ps($param)][getHelpIcon $param $hlpBoxWidth $hlpBoxHeight]</td>"
  append HTML_PARAMS(separate_1) "</tr>"
