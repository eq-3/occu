...
set PROFILE_1(LONG_OFFDELAY_TIME)	{0 range 0.0 - 111600.0}
...
set PROFILE_2(LONG_ON_TIME)			{111600 range 0.0 - 111600.0}
...
set PROFILE_2(SHORT_ONDELAY_TIME)	{0 range 0.0 - 111600.0}
