...
set PROFILE_1(SHORT_COND_VALUE_LO_SIRSEN)  255
set PROFILE_1(SHORT_CT_OFF_SIRSEN)  2
set PROFILE_1(SHORT_CT_OFFDELAY_SIRSEN)  2
set PROFILE_1(SHORT_CT_ON_SIRSEN)  2
set PROFILE_1(SHORT_CT_ONDELAY_SIRSEN)  2
...
set PROFILE_2(SHORT_ACTION_TYPE_SIRSEN) 0
set PROFILE_2(SHORT_JT_OFF_SIRSEN)      0
set PROFILE_2(SHORT_JT_ON_SIRSEN)      0
set PROFILE_2(SHORT_JT_OFFDELAY_SIRSEN)  0
...
#1  Alarm Ein
  ...
  append HTML_PARAMS(separate_$prn) [get_ComboBox options SHORT_ON_TIME_MODE_SIRSEN separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_ON_TIME_MODE_SIRSEN "onchange=\"MD_checkPNAME('separate_${special_input_id}_1_1','md_verweildauer_1_2', 'separate_${special_input_id}_1_2');\""]
  ...
  set absolut_minimal  $ps(SHORT_ON_TIME_MODE_SIRSEN)
  ...
  # Brightness
  incr pref ;# 4
  catch {EnterBrightness $prn $pref ${special_input_id} ps ps_descr SHORT_COND_VALUE_LO_SIRSEN}
