...
set PROFILE_1(UI_DESCRIPTION)	"Bei Feueralarm wird der Alarm f&uuml;r die eingestellte Zeit eingeschaltet. Wird der Alarm am ausl&ouml;senden oder, wahlweise, einem Rauchmelder der gleichen Gruppe best&auml;tigt, wird er ausgeschaltet."
set PROFILE_1(UI_TEMPLATE)	"Bei Feueralarm wird der Alarm f&uuml;r die eingestellte Zeit eingeschaltet. Wird der Alarm am ausl&ouml;senden oder, wahlweise, einem Rauchmelder der gleichen Gruppe best&auml;tigt, wird er ausgeschaltet."
