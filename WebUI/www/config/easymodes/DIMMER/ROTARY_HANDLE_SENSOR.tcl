...
source [file join $env(DOCUMENT_ROOT) config/easymodes/DIMMER/mapping/ROTARY_HANDLE_SENSOR_map.tcl]
...
#set PROFILE_14(UI_MAP) 1
#set PROFILE_15(UI_MAP) 2
...
set PROFILE_1(UI_DEFINITION_1_1)  "gekippt oder ganz offen"
set PROFILE_1(UI_DEFINITION_1_2)  "ganz offen"
set PROFILE_1(UI_DESCRIPTION) "Beim &Ouml;ffnen des Fensters wird das Licht auf die eingestellte Helligkeit eingeschaltet und beim Schlie&szlig;en ausgeschaltet. Die Schaltzuordnung l&auml;sst sich auch umkehren."
...
set PROFILE_2(SHORT_COND_VALUE_LO)  150
...
set PROFILE_2(SHORT_ELSE_ACTION_TYPE)  0
set PROFILE_2(UI_DESCRIPTION) "Bei ausgew&auml;hlten Fensterzustandswechseln wird das Licht f&uuml;r eine bestimmte Zeit auf die eingestellte Helligkeit eingeschaltet."
...
#1
  ...
  array_clear options
  set options(50) "\${tilt_open}" 
  set options(150) "\${open}"  
