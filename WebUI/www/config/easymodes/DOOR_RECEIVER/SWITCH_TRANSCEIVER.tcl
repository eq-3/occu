...
set PROFILES_MAP(3)  "\${switch_open}"
set PROFILES_MAP(4)  "\${switch_close}"
set PROFILES_MAP(5)  "\${switch_stop}"
set PROFILES_MAP(6)  "\${switch_partialOpen}"
...
set PROFILE_2(LONG_JT_RAMPOFF) 2
set PROFILE_2(LONG_JT_RAMPON) 2
set PROFILE_2(LONG_PROFILE_ACTION_TYPE) 2
...
set PROFILE_2(SHORT_JT_ON)      $CLOSE
set PROFILE_2(SHORT_JT_RAMPOFF) $STOP
set PROFILE_2(SHORT_JT_RAMPON)  $STOP
set PROFILE_2(SHORT_PROFILE_ACTION_TYPE) 2
...
set PROFILE_3(LONG_JT_RAMPOFF)  $OPEN
set PROFILE_3(LONG_JT_RAMPON)   $OPEN
...
set PROFILE_3(SHORT_JT_RAMPOFF) $OPEN
set PROFILE_3(SHORT_JT_RAMPON)  $OPEN
...
set PROFILE_4(LONG_JT_OFF)      $CLOSE
set PROFILE_4(LONG_JT_ON)       $CLOSE
set PROFILE_4(LONG_JT_RAMPOFF)  $CLOSE
set PROFILE_4(LONG_JT_RAMPON)   $CLOSE
...
set PROFILE_4(SHORT_JT_OFF)     $CLOSE
set PROFILE_4(SHORT_JT_ON)      $CLOSE
set PROFILE_4(SHORT_JT_RAMPOFF) $CLOSE
set PROFILE_4(SHORT_JT_RAMPON)  $CLOSE
...
set PROFILE_5(LONG_JT_OFF)      $STOP
set PROFILE_5(LONG_JT_ON)       $STOP
set PROFILE_5(LONG_JT_RAMPOFF)  $STOP
set PROFILE_5(LONG_JT_RAMPON)   $STOP
...
set PROFILE_5(SHORT_JT_OFF)     $STOP
set PROFILE_5(SHORT_JT_ON)      $STOP
set PROFILE_5(SHORT_JT_RAMPOFF) $STOP
set PROFILE_5(SHORT_JT_RAMPON)  $STOP
...
set PROFILE_6(LONG_JT_OFF)      $PARTIAL_OPEN
set PROFILE_6(LONG_JT_ON)       $PARTIAL_OPEN
set PROFILE_6(LONG_JT_RAMPOFF)  $PARTIAL_OPEN
set PROFILE_6(LONG_JT_RAMPON)   $PARTIAL_OPEN
set PROFILE_6(LONG_PROFILE_ACTION_TYPE) 1
...
set PROFILE_6(SHORT_JT_OFF)     $PARTIAL_OPEN
set PROFILE_6(SHORT_JT_ON)      $PARTIAL_OPEN
set PROFILE_6(SHORT_JT_RAMPOFF) $PARTIAL_OPEN
set PROFILE_6(SHORT_JT_RAMPON)  $PARTIAL_OPEN
