...
set PROFILE_1(SHORT_CT_REFOFF) 2
set PROFILE_1(SHORT_CT_REFON) 2
...
set PROFILE_2(SHORT_CT_REFOFF) 2
set PROFILE_2(SHORT_CT_REFON) 2
...
set PROFILE_3(SHORT_CT_REFOFF) 2
set PROFILE_3(SHORT_CT_REFON) 2
...
set PROFILE_4(SHORT_CT_OFF) 2
set PROFILE_4(SHORT_CT_OFFDELAY) 2
set PROFILE_4(SHORT_CT_ON) 2
set PROFILE_4(SHORT_CT_ONDELAY) 2
set PROFILE_4(SHORT_CT_RAMPOFF) 2
set PROFILE_4(SHORT_CT_RAMPON) 2
set PROFILE_4(SHORT_CT_REFOFF) 2
set PROFILE_4(SHORT_CT_REFON) 2
...
#4 jalousie target position
  ...
  append HTML_PARAMS(separate_$prn) "<script type=\"text/javascript\">window.setTimeout(function() {BLIND_setPosition('separate_${special_input_id}_4_1');jalousieShowSlatInputElem('separate_${special_input_id}_4_1', $ch);},200)</script>"
