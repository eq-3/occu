...
set PROFILE_6(SHORT_JT_ON)      0
set PROFILE_6(SHORT_JT_OFFDELAY)  0
set PROFILE_6(SHORT_JT_ONDELAY)    0
set PROFILE_6(SHORT_JT_RAMPOFF) 0
set PROFILE_6(SHORT_JT_RAMPON) 0
set PROFILE_6(UI_DESCRIPTION)  "Der Sensor ist au&szlig;er Betrieb."
...
# die Texte der Platzhalter einlesen
  puts "<script type=\"text/javascript\">getLangInfo('$dev_descr_sender(TYPE)_$rightRotation', '$dev_descr_receiver(TYPE)');</script>"
  puts "<script type=\"text/javascript\">getLangInfo_Special('HmIP_DEVICES.txt');</script>"
  puts "<script type=\"text/javascript\">jQuery('#dev_descr_sender_tmp').val('$dev_descr_sender(TYPE)_$rightRotation');</script>"
