...
set PROFILE_3(LONG_JT_OFF)       [subst {$ON_DELAY}]
set PROFILE_3(LONG_JT_OFFDELAY)  [subst {$OFF_DELAY $REFOFF $ON}]
set PROFILE_3(LONG_JT_ON)        [subst {$OFF_DELAY $ON_DELAY}]
set PROFILE_3(LONG_JT_ONDELAY)   [subst {$ON_DELAY $REFON}]
set PROFILE_3(LONG_JT_RAMPOFF)   [subst {$RAMP_ON $OFF}]
set PROFILE_3(LONG_JT_RAMPON)    [subst {$RAMP_OFF $ON}]
set PROFILE_3(LONG_JT_REFOFF)    [subst {$REFON $REFOFF $OFF}]
set PROFILE_3(LONG_JT_REFON)     [subst {$REFOFF $REFON $ON}]
...
set PROFILE_4(LONG_JT_RAMPOFF)   $RAMP_OFF
set PROFILE_4(LONG_JT_RAMPON)    $RAMP_ON
set PROFILE_4(LONG_JT_REFOFF)    $REFOFF
set PROFILE_4(LONG_JT_REFON)     $REFON
set PROFILE_4(LONG_MAX_TIME_FIRST_DIR) 0.000000
...
set SUBSET_1(LONG_JT_RAMPOFF)  $RAMP_OFF
