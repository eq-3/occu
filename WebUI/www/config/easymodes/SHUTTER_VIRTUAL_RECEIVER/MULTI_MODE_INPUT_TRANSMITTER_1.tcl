...
set PROFILE_1(LONG_MAX_TIME_FIRST_DIR) {0.4 range 0.0 - 25.5}
...
set PROFILE_1(LONG_PROFILE_ACTION_TYPE) {5 1}
...
set PROFILE_2(LONG_MAX_TIME_FIRST_DIR) {0.4 range 0.0 - 25.5}
...
set PROFILE_2(LONG_PROFILE_ACTION_TYPE) {5 1}
...
set PROFILE_3(LONG_OFF_LEVEL_2) {1.01 0}
...
set PROFILE_3(LONG_ON_LEVEL_2) {1.01 1.0}
...
set PROFILE_3(SHORT_ON_LEVEL_2) {1.01 1.0}
...
set PROFILE_4(LONG_MAX_TIME_FIRST_DIR) {0.4 range 0.0 - 25.5}
...
set PROFILE_4(LONG_PROFILE_ACTION_TYPE) {5 1}
...
set PROFILE_5(LONG_COND_VALUE_HI) {150 100}
...
set PROFILE_5(LONG_JT_OFFDELAY) {1 8}
set PROFILE_5(LONG_JT_ON) {1 4}
set PROFILE_5(LONG_JT_ONDELAY) {7 4}
set PROFILE_5(LONG_JT_RAMPOFF) {6 5}
set PROFILE_5(LONG_JT_RAMPON) {2 3}
set PROFILE_5(LONG_JT_REFOFF) {6 5}
set PROFILE_5(LONG_JT_REFON) {2 3}
...
set PROFILE_5(LONG_OFF_LEVEL) {0.0 range 0.0 - 1.01}
set PROFILE_5(LONG_OFF_LEVEL_2) {1.01 range 0.0 - 1.01}
...
set PROFILE_5(SHORT_ON_LEVEL) {1.0 range 0.0 - 1.01}
set PROFILE_5(SHORT_ON_LEVEL_2) {1.01 range 0.0 - 1.01}
set PROFILE_5(LONG_ON_TIME_BASE) 7
set PROFILE_5(LONG_ON_TIME_FACTOR) 31
set PROFILE_5(LONG_ON_TIME_MODE) 0
set PROFILE_5(LONG_PROFILE_ACTION_TYPE) {5 1}
set PROFILE_5(SHORT_COND_VALUE_HI) {150 100}
...
set PROFILE_5(SHORT_JT_OFFDELAY)  [subst {$ON_DELAY $OFF_DELAY $REFOFF}]
set PROFILE_5(SHORT_JT_ON)        [subst {$ON_DELAY $OFF_DELAY}]
set PROFILE_5(SHORT_JT_ONDELAY)   [subst {$REFON $ON_DELAY $OFF_DELAY}]
set PROFILE_5(SHORT_JT_RAMPOFF)   [subst {$OFF $RAMP_OFF}]
set PROFILE_5(SHORT_JT_RAMPON)    [subst {$RAMP_ON $ON}]
set PROFILE_5(SHORT_JT_REFOFF)    [subst {$OFF $REFON $RAMP_OFF}]
set PROFILE_5(SHORT_JT_REFON)     [subst {$RAMP_ON $REFOFF $ON}]
...
set PROFILE_5(SHORT_OFF_LEVEL) {0.0 range 0.0 - 1.01}
set PROFILE_5(SHORT_OFF_LEVEL_2) {1.01 range 0.0 - 1.01}
...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
  ...
  global dev_descr_sender dev_descr_receiver url receiver_address sender_address
