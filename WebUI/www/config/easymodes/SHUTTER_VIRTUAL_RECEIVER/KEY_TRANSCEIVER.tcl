...
set PROFILE_1(LONG_MAX_TIME_FIRST_DIR) 0.000000
...
set PROFILE_2(LONG_MAX_TIME_FIRST_DIR) 0.000000
...
set PROFILE_3(LONG_MAX_TIME_FIRST_DIR) 0.000000
...
set PROFILE_4(LONG_DRIVING_MODE) {0 1 2 3}

set PROFILE_4(LONG_JT_OFF) {0 range 0 - 8}
set PROFILE_4(LONG_JT_OFFDELAY) {0 range 0 - 8}
set PROFILE_4(LONG_JT_ON) {0 range 0 - 8}
set PROFILE_4(LONG_JT_ONDELAY) {0 range 0 - 8}
set PROFILE_4(LONG_JT_RAMPOFF) {0 range 0 - 8}
set PROFILE_4(LONG_JT_RAMPON) {0 range 0 - 8}
set PROFILE_4(LONG_JT_REFOFF) {0 range 0 - 8}
set PROFILE_4(LONG_JT_REFON) {0 range 0 - 8}

set PROFILE_4(LONG_MAX_TIME_FIRST_DIR) 0.4
...
set PROFILE_4(SHORT_JT_OFF) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_OFFDELAY) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_ON) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_ONDELAY) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_RAMPOFF) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_RAMPON) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_REFOFF) {0 range 0 - 8}
set PROFILE_4(SHORT_JT_REFON) {0 range 0 - 8}
...
set SUBSET_1(LONG_JT_ONDELAY)  7
set SUBSET_1(LONG_JT_RAMPOFF)    6
set SUBSET_1(LONG_JT_RAMPON)    2
set SUBSET_1(LONG_JT_REFOFF)    6
...
set SUBSET_1(SHORT_JT_RAMPOFF)    6
set SUBSET_1(SHORT_JT_RAMPON)    3
set SUBSET_1(SHORT_JT_REFOFF)    6
...
set SUBSET_2(LONG_JT_OFFDELAY) 4
set SUBSET_2(LONG_JT_ON)      4
set SUBSET_2(LONG_JT_ONDELAY)   7
set SUBSET_2(LONG_JT_RAMPOFF)    4
set SUBSET_2(LONG_JT_RAMPON)    3
set SUBSET_2(LONG_JT_REFOFF)    5
