...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
  ...
  append HTML_PARAMS(separate_1) "<table class=\"ProfileTbl\">"
    ...
    append HTML_PARAMS(separate_1) "<tr>"
      append HTML_PARAMS(separate_1) "<td>\${stringTableDimmerOverTempLevel}</td>"
      append HTML_PARAMS(separate_1)  "<td>[getTextField $param $ps($param) $chn $prn]</td><td>[getUnit $param]&nbsp;[getMinMaxValueDescr $param]</td>"
    append HTML_PARAMS(separate_1) "</tr>"

    incr prn
    set param REDUCE_LEVEL
    append HTML_PARAMS(separate_1) "<tr>"
      append HTML_PARAMS(separate_1) "<td>\${stringTableDimmerReduceLevel}</td>"
      append HTML_PARAMS(separate_1)  "<td>[getTextField100Percent $param $ps($param) $chn $prn]</td><td>[getUnit $param]&nbsp;[getMinMaxValueDescr $param]</td>"
    append HTML_PARAMS(separate_1) "</tr>"

    incr prn
    set param REDUCE_TEMP_LEVEL
    append HTML_PARAMS(separate_1) "<tr>"
      append HTML_PARAMS(separate_1) "<td>\${stringTableDimmerReduceTempLevel}</td>"
      append HTML_PARAMS(separate_1)  "<td>[getTextField $param $ps($param) $chn $prn]</td><td>[getUnit $param]&nbsp;[getMinMaxValueDescr $param]</td>"
    append HTML_PARAMS(separate_1) "</tr>"
    ...
    append HTML_PARAMS(separate_1) "<tr>"
      append HTML_PARAMS(separate_1) "<td>\${stringTableDimmerCharacteristic}</td>"
      array_clear options
