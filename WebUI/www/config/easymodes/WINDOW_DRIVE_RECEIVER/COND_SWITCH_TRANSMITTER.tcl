...
set PROFILE_1(SHORT_COND_VALUE_HI)  {200 150}
...
set PROFILE_2(SHORT_COND_VALUE_HI)  200
set PROFILE_2(SHORT_COND_VALUE_LO)  0

set PROFILE_2(SHORT_CT_OFF)       {1 4}
set PROFILE_2(SHORT_CT_OFFDELAY)  {1 4}
set PROFILE_2(SHORT_CT_ON)        {4 1}
set PROFILE_2(SHORT_CT_ONDELAY)   {4 1}
set PROFILE_2(SHORT_CT_RAMPOFF)   {1 4}
set PROFILE_2(SHORT_CT_RAMPON)    {4 1}
...
set PROFILE_3(SHORT_COND_VALUE_HI)  200
set PROFILE_3(SHORT_COND_VALUE_LO)  0
...
#set SUBSET_1(NAME)          "Oberer Grenzwert &uuml;berschritten - auf / Unterer Grenzwert unterschritten - zu"
...
#set SUBSET_2(NAME)          "Oberer Grenzwert &uuml;berschritten - auf / Unterer Grenzwert unterschritten - zu"
...
set SUBSET_2(SHORT_CT_RAMPOFF)  4
...
#1
  ...
  # ONDELAY
  append HTML_PARAMS(separate_$prn) "[getTimeSelector WINDOW_ONDELAY_TIME_FACTOR_DESCR ps PROFILE_$prn delay $prn $special_input_id SHORT_ONDELAY_TIME TIMEBASE_LONG]"

  # ON_TIME
  append HTML_PARAMS(separate_$prn) "[getTimeSelector WINDOW_ONTIME_FACTOR_DESCR ps PROFILE_$prn timeOnOff $prn $special_input_id SHORT_ON_TIME TIMEBASE_LONG]"

  # OFFDELAY
  ## append HTML_PARAMS(separate_$prn) "[getTimeSelector WINDOW_OFFDELAY_TIME_FACTOR_DESCR ps PROFILE_$prn delay $prn $special_input_id SHORT_OFFDELAY_TIME TIMEBASE_LONG]"
