...
set PROFILE_1(SHORT_CT_REFOFF) {0 1 2 4}
set PROFILE_1(SHORT_CT_REFON) {0 1 2 4}
set PROFILE_1(SHORT_DRIVING_MODE) 0
set PROFILE_1(SHORT_JT_OFF)       $ONDELAY
set PROFILE_1(SHORT_JT_OFFDELAY)  $ON
set PROFILE_1(SHORT_JT_ON)        $ONDELAY
set PROFILE_1(SHORT_JT_ONDELAY)   $ONDELAY
set PROFILE_1(SHORT_JT_RAMPOFF)   $RAMPON
set PROFILE_1(SHORT_JT_RAMPON)    $RAMPON
...
set PROFILE_2(SHORT_CT_RAMPOFF) {0 1 2 4}
set PROFILE_2(SHORT_CT_RAMPON) {0 1 2 4}
set PROFILE_2(SHORT_CT_REFOFF) {0 1 2 4}
set PROFILE_2(SHORT_CT_REFON) {0 1 2 4}
set PROFILE_2(SHORT_DRIVING_MODE) 0
set PROFILE_2(SHORT_JT_OFF)       $OFFDELAY
set PROFILE_2(SHORT_JT_OFFDELAY)  $OFFDELAY
set PROFILE_2(SHORT_JT_ON)        $OFFDELAY
set PROFILE_2(SHORT_JT_ONDELAY)   $OFF
set PROFILE_2(SHORT_JT_RAMPOFF)   $RAMPOFF
set PROFILE_2(SHORT_JT_RAMPON)    $RAMPOFF
...
#DEFAULT_PROFILE
set PROFILE_3(SHORT_COND_VALUE_HI) {150 100}
...
set PROFILE_3(SHORT_CT_RAMPOFF) {0 1 2 4}
set PROFILE_3(SHORT_CT_RAMPON) {0 1 2 4}
set PROFILE_3(SHORT_CT_REFOFF) {0 1 2 4}
set PROFILE_3(SHORT_CT_REFON) {0 1 2 4}
set PROFILE_3(SHORT_DRIVING_MODE) 0
set PROFILE_3(SHORT_JT_OFF)       [subst {$ONDELAY}]
set PROFILE_3(SHORT_JT_OFFDELAY)  [subst {$OFFDELAY $REFOFF}]
set PROFILE_3(SHORT_JT_ON)        $OFFDELAY
set PROFILE_3(SHORT_JT_ONDELAY)   [subst {$ONDELAY $REFON}]
set PROFILE_3(SHORT_JT_RAMPOFF)   [subst {$RAMPON $OFF}]
set PROFILE_3(SHORT_JT_RAMPON)    [subst {$RAMPOFF $ON}]
...
set PROFILE_4(SHORT_CT_OFF) {0 1 2 4}
...
set PROFILE_4(SHORT_CT_REFOFF) {0 1 2 4}
set PROFILE_4(SHORT_CT_REFON) {0 1 2 4}
set PROFILE_4(SHORT_DRIVING_MODE) 0
set PROFILE_4(SHORT_JT_OFF)       [subst {$ONDELAY $OFFDELAY}]
set PROFILE_4(SHORT_JT_OFFDELAY)  [subst {$ON $OFFDELAY}]
set PROFILE_4(SHORT_JT_ON)        [subst {$ONDELAY $OFFDELAY}]
set PROFILE_4(SHORT_JT_ONDELAY)   [subst {$ONDELAY $OFF}]
set PROFILE_4(SHORT_JT_RAMPOFF)   [subst {$ON $RAMPOFF $RAMPON}]
set PROFILE_4(SHORT_JT_RAMPON)    [subst {$OFF $RAMPOFF $RAMPON}]
...
set SUBSET_1(SHORT_JT_OFF)      $ONDELAY
set SUBSET_1(SHORT_JT_OFFDELAY) $ON
set SUBSET_1(SHORT_JT_ON)       $ONDELAY
set SUBSET_1(SHORT_JT_ONDELAY)  $ONDELAY
set SUBSET_1(SHORT_JT_RAMPOFF)  $RAMPON
set SUBSET_1(SHORT_JT_RAMPON)   $RAMPON
...
set SUBSET_2(SHORT_JT_OFF)       $OFFDELAY
set SUBSET_2(SHORT_JT_OFFDELAY)  $OFFDELAY
set SUBSET_2(SHORT_JT_ON)        $OFFDELAY
set SUBSET_2(SHORT_JT_ONDELAY)   $OFF
set SUBSET_2(SHORT_JT_RAMPOFF)   $RAMPOFF
set SUBSET_2(SHORT_JT_RAMPON)    $RAMPOFF
...
set SUBSET_3(SHORT_JT_OFF)      $ONDELAY
set SUBSET_3(SHORT_JT_OFFDELAY) $OFFDELAY
set SUBSET_3(SHORT_JT_ON)       $OFFDELAY
set SUBSET_3(SHORT_JT_ONDELAY)  $ONDELAY
set SUBSET_3(SHORT_JT_RAMPOFF)  $RAMPON
set SUBSET_3(SHORT_JT_RAMPON)   $RAMPOFF
...
set SUBSET_5(SHORT_CT_REFOFF)   1
set SUBSET_5(SHORT_CT_REFON)    1
...
set SUBSET_6(SHORT_CT_REFOFF)   0
set SUBSET_6(SHORT_CT_REFON)    0
...
set SUBSET_7(SHORT_CT_REFOFF)   2
set SUBSET_7(SHORT_CT_REFON)    2
...
#1
  ...
  append HTML_PARAMS(separate_$prn) [subset2combobox {SUBSET_4 SUBSET_5 SUBSET_6 SUBSET_7} subset_$prn\_$pref separate_${special_input_id}_$prn\_$pref PROFILE_$prn ]
