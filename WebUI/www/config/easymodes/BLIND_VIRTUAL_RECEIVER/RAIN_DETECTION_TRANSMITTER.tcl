...
set PROFILE_1(SHORT_OFF_LEVEL) {0.0 range 0.0 - 1.01}
...
#1
  ...
  incr pref
  append HTML_PARAMS(separate_$prn) "<tr><td>\${JALOUSIE_SLAT_POS_ON}</td><td>"
  option BLIND_LEVEL
  #set options(1.005) "\${lastValue}"
  #set options(1.010) "\${noModification}"
  ...
  incr pref
  append HTML_PARAMS(separate_$prn) "<tr><td>\${JALOUSIE_SLAT_POS_OFF}</td><td>"
  option BLIND_LEVEL
  #set options(1.005) "\${lastValue}"
  #set options(1.010) "\${noModification}"
