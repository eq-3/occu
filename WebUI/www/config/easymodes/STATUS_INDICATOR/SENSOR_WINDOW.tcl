...
set PROFILE_1(UI_DESCRIPTION)	"Beim &Ouml;ffnen des Kontaktes wird die Anzeige ein- und beim Schlie&szlig;en ausgeschaltet. Die Schaltzuordnung l&auml;sst sich auch umkehren."
...
set PROFILE_2(UI_DESCRIPTION)	"Bei Erkennung des &Auml;nderungssignals wird die Anzeige f&uuml;r eine bestimmte Zeit eingeschaltet."
set PROFILE_2(UI_TEMPLATE)		$PROFILE_2(UI_DESCRIPTION)
set PROFILE_2(UI_HINT)	2

set PROFILE_3(LONG_ACTION_TYPE)		{0 1}
