...
set PROFILE_1(UI_DESCRIPTION)	"Beim Ausl&ouml;sen des Sensors wird der Gong bet&auml;tigt. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so wird er erst nach Ablauf dieser Zeit eingeschaltet."
