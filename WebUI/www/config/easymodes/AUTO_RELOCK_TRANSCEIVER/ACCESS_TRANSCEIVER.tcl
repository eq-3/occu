...
source [file join $env(DOCUMENT_ROOT) config/easymodes/AUTO_RELOCK_TRANSCEIVER/profiles.tcl]

set PROFILES_MAP(0)  "\${expert}"
set PROFILES_MAP(1)  "\${toggle}"
set PROFILES_MAP(2)  "\${autoRelockOn}"
set PROFILES_MAP(3)  "\${autoRelockOff}"
