...
set PROFILE_1(LONG_ON_LEVEL)		{1.0 range 0.0 - 1.0}
...
set PROFILE_3(LONG_ON_LEVEL)		{1.0 range 0.0 - 1.0}
...
set PROFILE_4(LONG_ON_LEVEL)		{0.9 range 0.0 - 1.0}
...
set PROFILE_4(SHORT_ON_LEVEL)		{0.9 range 0.0 - 1.0}
...
set PROFILE_5(LONG_ON_LEVEL)		{0.5 range 0.0 - 1.0}
...
set PROFILE_5(SHORT_ON_LEVEL)		{0.5 range 0.0 - 1.0}
...
set PROFILE_6(LONG_ON_LEVEL)		{1.0 range 0.0 - 1.0}
...
set PROFILE_6(SHORT_ON_LEVEL)		{1.0 range 0.0 - 1.0}
...
set PROFILE_7(LONG_ON_LEVEL)		{0.8 range 0.0 - 1.0}
...
set PROFILE_7(SHORT_ON_LEVEL)		{0.8 range 0.0 - 1.0}
...
set PROFILE_8(LONG_ON_LEVEL)		{1.0 range 0.0 - 1.0}
...
set PROFILE_8(SHORT_ON_LEVEL)		{1.0 range 0.0 - 1.0}
...
#12
	...
	append HTML_PARAMS(separate_$prn) "<div id=\"param_$prn\"><textarea id=\"profile_$prn\" style=\"display:none\">"
	#append HTML_PARAMS(separate_$prn) "\${description_$prn}"
	append HTML_PARAMS(separate_$prn) "\${description_12}"
	append HTML_PARAMS(separate_$prn) "<table class=\"ProfileTbl\">"
