...
set PROFILE_1(LONG_ON_LEVEL) 1.0
...
set PROFILE_3(LONG_ON_MIN_LEVEL) 0.05
...
set PROFILE_4(LONG_OFF_TIME) 1.0
...
set PROFILE_4(SHORT_OFF_TIME)  1.0
...
set PROFILE_4(SHORT_ON_TIME) 1.0
...
set PROFILE_5(LONG_ON_TIME)  111600.0
...
set PROFILE_5(SHORT_ON_TIME) 111600.0
...
set PROFILE_6(LONG_OFF_LEVEL)  0.0
set PROFILE_6(LONG_OFF_TIME) 111600.0
...
set PROFILE_6(LONG_ON_LEVEL) 1.0
...
set PROFILE_6(LONG_RAMPOFF_TIME) 0.5
...
set PROFILE_6(SHORT_OFF_LEVEL) 0.0
set PROFILE_6(SHORT_OFF_TIME)  111600.0
...
set PROFILE_6(SHORT_ON_LEVEL)  1.0
...
set PROFILE_6(SHORT_RAMPOFF_TIME)  0.5
...
set PROFILE_7(LONG_ON_LEVEL) 1.0
...
set PROFILE_7(SHORT_ON_LEVEL)  1.0
...
set PROFILE_8(LONG_ON_TIME)  1.0
...
set PROFILE_8(SHORT_ON_TIME) 1.0
...
#1
  ...
  option RAMPTIME
  append HTML_PARAMS(separate_$prn) [get_ComboBox options $param separate_${special_input_id}_$prn\_$pref PROFILE_$prn $param "onchange=\"ActivateFreeTime(\$('${special_input_id}_profiles'),$pref);\""]
  ...
  option DIM_ONLEVEL
  append HTML_PARAMS(separate_$prn) [get_ComboBox options $param separate_${special_input_id}_$prn\_$pref PROFILE_$prn $param "onchange=\"ActivateFreePercent(\$('${special_input_id}_profiles'),$pref);\""]
...
#3
  ...
  append HTML_PARAMS(separate_$prn) "<tr><td>\${OFF_TIME}</td><td>"
  option LENGTH_OF_STAY
  append HTML_PARAMS(separate_$prn) [get_ComboBox options SHORT_OFF_TIME|LONG_ON_TIME separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_OFF_TIME "onchange=\"ActivateFreeTime(\$('${special_input_id}_profiles'),$pref);\""]
  ...
  append HTML_PARAMS(separate_$prn) "<tr><td>\${OFF_LEVEL}</td><td>"
  option DIM_ONLEVEL
  append HTML_PARAMS(separate_$prn) [get_ComboBox options SHORT_OFF_LEVEL|LONG_ON_LEVEL separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_OFF_LEVEL "onchange=\"ActivateFreePercent(\$('${special_input_id}_profiles'),$pref);\""]
...
#6
  ...
  append HTML_PARAMS(separate_$prn) "<tr><td>\${RAMPOFF_TIME}</td><td>"
  option RAMPTIME
  append HTML_PARAMS(separate_$prn) [get_ComboBox options LONG_RAMPOFF_TIME|SHORT_RAMPOFF_TIME separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_RAMPOFF_TIME "onchange=\"ActivateFreeTime(\$('${special_input_id}_profiles'),$pref);\""]
  EnterTime_h_m_s $prn $pref ${special_input_id} ps_descr SHORT_RAMPOFF_TIME
  append HTML_PARAMS(separate_$prn) "</td></tr>"
