...
set PROFILE_1(SHORT_COND_VALUE_HI) {150 100}
...
set PROFILE_2(SHORT_COND_VALUE_HI) {151 100}
...
set PROFILE_2(SHORT_PROFILE_REPETITIONS) {0 range 0 - 225}
set PROFILE_2(SHORT_RAMPOFF_TIME_BASE) {0 range 0 - 7}
set PROFILE_2(SHORT_RAMPOFF_TIME_FACTOR) {0 range 0 - 31}
...
set PROFILE_3(UI_DESCRIPTION)  "Der Regensensor ist au&szlig;er Betrieb."
