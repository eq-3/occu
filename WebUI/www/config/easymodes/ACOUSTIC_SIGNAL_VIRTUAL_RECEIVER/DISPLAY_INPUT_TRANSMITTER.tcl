...
set PROFILES_MAP(2)   "\${dimmer_on_brighter}"
set PROFILES_MAP(3)   "\${dimmer_off_darker}"
set PROFILES_MAP(4)   "\${dimmer_on_off_b_d}"
...
set PROFILE_1(LONG_OUTPUT_BEHAVIOUR) {0 range 0 - 255}
...
set PROFILE_2(LONG_JT_OFFDELAY) 2
set PROFILE_2(LONG_JT_ON) 2
...
set PROFILE_2(LONG_OUTPUT_BEHAVIOUR) {0 range 0 - 255}
set PROFILE_2(LONG_PROFILE_ACTION_TYPE) 3
set PROFILE_2(LONG_PROFILE_REPETITIONS) {0 range 0 - 255}
...
set PROFILE_3(LONG_COND_VALUE_HI) {150 100}
...
set PROFILE_3(LONG_ON_LEVEL) {0.0 range 0.0 - 1.005}
set PROFILE_3(LONG_ON_MIN_LEVEL) {0.1 range 0.0 - 1.0}
set PROFILE_3(LONG_ON_TIME_MODE) 0
set PROFILE_3(LONG_OUTPUT_BEHAVIOUR) {0 range 0 - 255}
set PROFILE_3(LONG_PROFILE_ACTION_TYPE) 4
...
set PROFILE_3(SHORT_OUTPUT_BEHAVIOUR) {255 range 0 - 255}
...
set PROFILE_3(SHORT_RAMPON_TIME_FACTOR) {0 range 0 - 31}
...
set PROFILE_4(LONG_OUTPUT_BEHAVIOUR) {254 range 0 - 255}
...
set PROFILE_4(SHORT_OFFDELAY_BLINK) 1
