...
set PROFILE_1(SHORT_RAMPON_SPEED)	1.0
set PROFILE_1(SHORT_RAMPOFF_SPEED)	1.0
set PROFILE_1(UI_DESCRIPTION)	"Bei erh&ouml;htem CO2-Gehalt der Luft wird das Fenster f&uuml;r die gew&uuml;nschte Zeit ge&ouml;ffnet."
...
#1
	...
	append HTML_PARAMS(separate_$prn)	"<tr><td>\${ON_AIRING}</td><td>"	
	array_clear options
