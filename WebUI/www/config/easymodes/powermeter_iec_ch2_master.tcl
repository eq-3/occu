  ...
  append HTML_PARAMS(separate_1) "<div id=\"ch2ParamTbl\" class=\"hidden\">"
    append HTML_PARAMS(separate_1) "<table class=\"ProfileTbl\">"
      ...
      append HTML_PARAMS(separate_1) "<tr name='sensor_3' class='hidden'>"
        ...
        append HTML_PARAMS(separate_1) "<td>[getTextField psDescr $CHANNEL $param $ps($param) separate_${special_input_id}_$prn][getHelpIcon "POWER_STRING_CH2" $hlpBoxWidth [expr $hlpBoxHeight * 1.6]]</td>"
      append HTML_PARAMS(separate_1) "</tr>"
      ...
      append HTML_PARAMS(separate_1) "<tr name='sensor_3' class='hidden'>"
        ...
        append HTML_PARAMS(separate_1) "<td>[getTextField psDescr $CHANNEL $param $ps($param) separate_${special_input_id}_$prn][getHelpIcon "ENERGY_COUNTER_STRING_CH2" $hlpBoxWidth $hlpBoxHeight]</td>"
      append HTML_PARAMS(separate_1) "</tr>"
