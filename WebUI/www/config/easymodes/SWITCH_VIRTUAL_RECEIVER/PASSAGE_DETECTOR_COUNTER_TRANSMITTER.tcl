...
set PROFILE_2(SHORT_CT_OFF)      {2 range 0 - 5}
set PROFILE_2(SHORT_CT_OFFDELAY)  {2 range 0 - 5}
...
set PROFILE_4(UI_DESCRIPTION)  "Bei Erkennung des &Auml;nderungssignals wird der Schalter f&uuml;r eine bestimmte Zeit eingeschaltet."
