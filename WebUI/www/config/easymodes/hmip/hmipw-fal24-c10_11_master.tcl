...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
  ...
  append HTML_PARAMS(separate_1) "<table name=\"noParamAvailable\" class=\"ProfileTbl\">"
    ...
    # Fw. >= 1.6
      ...
      # show 1.6 channel CLIMATECONTROL_HEAT_DEMAND_BOILER_TRANSMITER
      set prn 1
      append HTML_PARAMS(separate_1) "[getClimateControlHeatDemandBoilerTransmitter $chn ps psDescr]"
    } else {
