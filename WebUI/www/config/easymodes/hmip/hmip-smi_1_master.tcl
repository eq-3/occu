...
###
  ...
  append HTML_PARAMS(separate_1) "<table class=\"ProfileTbl\">"
    ...
    set comment {
      incr pref; # 3
      append HTML_PARAMS(separate_1) "<script type=\"text/javascript\">MD_proofClassic(\'separate_${special_input_id}_$pref\');</script>"


      append HTML_PARAMS(separate_1) "<tr><td>\${motionDetectorOnAirIntervalMode}</td><td>"
      append HTML_PARAMS(separate_1) "<select id=\"separate_${special_input_id}_$pref\" name=\"MD_sendmode\"onchange=\"MD_minInterval(\'separate_${special_input_id}_$pref\');\"><option>\${motionDetectorOnAirIntervalModeClassic}</option><option>\${motionDetectorOnAirIntervalModeDynamic}</option></select>"
    ...
    append HTML_PARAMS(separate_1) "<tr>"
      append HTML_PARAMS(separate_1) "<td><span id=\"min_interval\" class=\"j_translate\">$PROFILE_PNAME(G)</span></td>"
