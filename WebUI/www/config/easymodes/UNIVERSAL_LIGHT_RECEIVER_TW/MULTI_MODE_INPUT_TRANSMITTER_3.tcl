...
set PROFILES_MAP(4)  "\${colortemp_a}"
set PROFILES_MAP(5)  "\${colortemp_b}"
set PROFILES_MAP(6)  "\${colortemp_a_b}"
set PROFILES_MAP(7)  "\${hcl_on}"
set PROFILES_MAP(8)  "\${hcl_off}"
set PROFILES_MAP(9)  "\${hcl_on_off}"
set PROFILES_MAP(10)  "\${dim2warm_on}"
set PROFILES_MAP(11)  "\${dim2warm_off}"
set PROFILES_MAP(12)  "\${dim2warm_on_off}"
