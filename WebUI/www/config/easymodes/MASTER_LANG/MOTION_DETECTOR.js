jQuery.extend(true,langJSON, {
  "de" : {
    ...
    "comment" : "Die folgenden Keys wurden für den HmIP-SAM (Erschütterungssensor) eingeführt.",
  ...
  "en" : {
    ...
    "motionDetectorFilterPeriod" : "en* Zeit, bis von der zuletzt erkannten Ersch%FCtterung<br/>zur%FCck auf Ruhe gewechselt werden kann",

    "motionDetectorChannelOperationMode" : "en* Art der Bewegungserkennung",
    "motionDetectorChannelOperationModeOff" : "en* Sensor nicht aktiv",
    "motionDetectorChannelOperationModeAnyMotion" : "en* Ersch%FCtterung",
    "motionDetectorChannelOperationModeFlat" : "en* Lage%E4nderung",

    "motionDetectorMessageMovement" : "en* Meldung im Zustand Bewegung",
    "motionDetectorMessageNoMovement" : "en* Meldung im Zustand Ruhe",
    "motionDetectorNotificationMovement" : "en* Benachrichtigungston Bewegung",
    "motionDetectorNotificationNoMovement" : "en* Benachrichtigungston Ruhe",
    "motionDetectorSensorSensivity" : "en* Empfindlichkeit des Sensors bei Ersch%FCtterung",
    "motionDetectorTriggerAngle" : "en* Winkel f%FCr die Lageerkennung",

    "motionDetectorOptionNoMessage" : "en* Keine Meldung",
    "motionDetectorOptionMotion": "en* Bewegung",
    "motionDetectorOptionNoMotion": "en* Ruhe",

    "motionDetectorSensorRange2GPlusSen" : "en* 2G+",
    "motionDetectorSensorRange2G2PlusSens" : "en* 2G++",
    "motionDetectorSensorRange2G" : "en* 2G",
    "motionDetectorSensorRange4G" : "en* 4G",
    "motionDetectorSensorRange8G" : "en* 8G",
    "motionDetectorSensorRange16G" : "en* 16G"
  ...
  "tr" : {
    ...
    "motionDetectorFilterPeriod" : "tr* Zeit, bis von der zuletzt erkannten Ersch%FCtterung<br/>zur%FCck auf Ruhe gewechselt werden kann",

    "motionDetectorChannelOperationMode" : "tr* Art der Bewegungserkennung",
    "motionDetectorChannelOperationModeOff" : "tr* Sensor nicht aktiv",
    "motionDetectorChannelOperationModeAnyMotion" : "tr* Ersch%FCtterung",
    "motionDetectorChannelOperationModeFlat" : "tr* Lage%E4nderung",

    "motionDetectorMessageMovement" : "tr* Meldung im Zustand Bewegung",
    "motionDetectorMessageNoMovement" : "tr* Meldung im Zustand Ruhe",
    "motionDetectorNotificationMovement" : "tr* Benachrichtigungston Bewegung",
    "motionDetectorNotificationNoMovement" : "tr* Benachrichtigungston Ruhe",
    "motionDetectorSensorSensivity" : "tr* Empfindlichkeit des Sensors bei Ersch%FCtterung",
    "motionDetectorTriggerAngle" : "tr* Winkel f%FCr die Lageerkennung",

    "motionDetectorOptionNoMessage" : "tr* Keine Meldung",
    "motionDetectorOptionMotion": "tr* Bewegung",
    "motionDetectorOptionNoMotion": "tr* Ruhe",

    "motionDetectorSensorRange2GPlusSen" : "tr* 2G+",
    "motionDetectorSensorRange2G2PlusSens" : "tr* 2G++",
    "motionDetectorSensorRange2G" : "tr* 2G",
    "motionDetectorSensorRange4G" : "tr* 4G",
    "motionDetectorSensorRange8G" : "tr* 8G",
    "motionDetectorSensorRange16G" : "tr* 16G"
  }
});
