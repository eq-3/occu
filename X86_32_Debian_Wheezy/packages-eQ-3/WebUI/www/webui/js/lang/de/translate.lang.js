...
jQuery.extend(true,langJSON, {
  "de" : {
    ...
    "ccuNotReady" : "Die " + HMIdentifier.de.CCUFullName + " ist noch nicht bereit",
    ...
    "lblSettingsFavorites2c" : "die " + HMIdentifier.de.CCUFullName,
    ...
    "dialogQuestionRestartSafeMode" : "M%F6chten Sie die " + HMIdentifier.de.CCUFullName + " wirklich im abgesicherten Modus starten?",
    ...
    "lblSysConfCentralMaintenance1" : "Software-Update der " + HMIdentifier.de.CCUFullName,
    "lblSysConfCentralMaintenance2" : HMIdentifier.de.CCUFullName + " neu starten",
    ...
    "dialogSettingsSecurityHintSecKey2" : "Der System-Sicherheitsschl%FCssel sollte mindestens 5 Zeichen lang sein.",
    ...
    "dialogSettingsNetworkHintCertificateP1" : "Um einen gesicherten Fernzugriff auf Ihre " + HMIdentifier.de.CCUFullName + " zu erm%F6glichen, k%F6nnen Sie hier ein Zertifikat erstellen.",
    ...
    "dialogSettingsNetworkHintCertificateP2c" : "Schritt 3: Zertifikat auf die " + HMIdentifier.de.CCUFullName + " %FCbertragen",
    "dialogSettingsNetworkHintCertificateP2d" : "Schritt 4: " + HMIdentifier.de.CCUFullName + " neu starten",
    "dialogSettingsNetworkHintCertificateP3" : "Zun%E4chst wird das Zertifikat online auf www.homematic.com erstellt. Daf%FCr ben%F6tigen Sie eine aktive Internetverbindung. Anschlie%DFend w%E4hlen Sie das erstellte Zertifikat aus und %FCbertragen es auf Ihre " + HMIdentifier.de.CCUFullName + ". Nach einem Neustart der " + HMIdentifier.de.CCUFullName + " k%F6nnen Sie %FCber eine gesicherte Verbindung auf die Zentrale zugreifen.",
    ...
    "btnSysConfLANGateway" : "LAN Gateway Konfiguration",
