...
set PROFILE_4(LONG_OFFDELAY_TIME) 20.0
...
set PROFILE_4(LONG_ON_LEVEL)    0.9
set PROFILE_4(LONG_ON_LEVEL_PRIO) 1
set PROFILE_4(LONG_ON_MIN_LEVEL)  0.1
set PROFILE_4(LONG_ON_TIME)     120.0
set PROFILE_4(LONG_ON_TIME_MODE)  1
set PROFILE_4(LONG_RAMPOFF_TIME)  20.0
set PROFILE_4(LONG_RAMPON_TIME)   0.5
...
set PROFILE_4(SHORT_OFFDELAY_TIME)  20.0
...
set PROFILE_6(LONG_OFF_TIME)    1.0
...
set PROFILE_6(LONG_ON_TIME)     1.0
...
set PROFILE_6(SHORT_OFF_TIME)   1.0
...
set PROFILE_6(SHORT_ON_TIME)    1.0
