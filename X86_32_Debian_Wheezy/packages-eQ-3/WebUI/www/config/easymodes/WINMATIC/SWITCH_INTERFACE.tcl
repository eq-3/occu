...
source [file join $env(DOCUMENT_ROOT) config/easymodes/WINMATIC/mapping/SWITCH_INTERFACE_map.tcl]


set PROFILES_MAP(0)	"\${expert}"
set PROFILES_MAP(1)	"\${window_close}" 			
set PROFILES_MAP(2)	"\${window_tilt}" 					
...
set PROFILE_1(SHORT_JT_OFF)		8
set PROFILE_1(SHORT_JT_ON)		8
set PROFILE_1(SHORT_JT_RAMPOFF)	8
set PROFILE_1(SHORT_JT_RAMPON)	8
...
set PROFILE_1(UI_DESCRIPTION)	"Bei Bet&auml;tigen des Tasters wird das Fenster verschlossen."
set PROFILE_1(UI_TEMPLATE)		$PROFILE_1(UI_DESCRIPTION)
set PROFILE_1(UI_HINT)	1

set PROFILE_2(SHORT_JT_OFF)		7
set PROFILE_2(SHORT_JT_ON)		7
...
set PROFILE_2(UI_DESCRIPTION)	"Bei Bet&auml;tigen des Tasters wird das Fenster auf die eingestellte Kippweite gekippt."
...
set PROFILE_3(UI_DESCRIPTION)	"Beim Bet&auml;tigen des Schalters schlie&szlig;t oder &ouml;ffnet das Fenster, je nach vorheriger Aktion. Beim Bet&auml;tigen des Schalters w&auml;hrend der Bewegung, wird die Bewegungsrichtung umgekehrt."
...
set PROFILE_4(UI_DESCRIPTION)	"Bei Bet&auml;tigen des Tasters wird das Fenster auf die eingestellte Kippweite gekippt und nach der eingestellten Zeit wieder geschlossen bzw. verriegelt."
...
#2
	...
	append HTML_PARAMS(separate_$prn) "<tr><td>\${WINDOW_OPEN_LEVEL}&nbsp;\${when_opening}</td><td>"
