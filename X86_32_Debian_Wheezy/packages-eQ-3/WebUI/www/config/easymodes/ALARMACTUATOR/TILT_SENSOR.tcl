...
set PROFILE_1(UI_DESCRIPTION)	"Beim &Ouml;ffnen des Garagentores wird der Alarm je nach aktuellem Zustand f&uuml;r die gew&auml;hlte Zeit ein- bzw. ausgeschaltet. Die Schaltrichtung l&auml;sst sich auch umkehren."
...
#1
	...
	# Beschreibungstext des Profils wird per Funktion SFA_subset_descr() gesetzt. 
