...
set PROFILE_1(UI_DESCRIPTION)	"Beim &Ouml;ffnen des Fensters wird die Temperatur auf die Absenktemperatur eingestellt."
set PROFILE_1(UI_TEMPLATE)	"Beim &Ouml;ffnen des Fensters wird die Temperatur auf #{TEMPERATUR_WINDOW_OPEN_VALUE} Grad C bzw. F eingestellt."
