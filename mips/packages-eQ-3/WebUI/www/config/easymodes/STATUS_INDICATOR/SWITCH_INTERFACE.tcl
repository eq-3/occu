...
set PROFILE_1(UI_DESCRIPTION)	"Bei Bet&auml;tigung des Schaltkontaktes wird die Anzeige der Statusanzeige eingeschaltet."
...
set PROFILE_2(UI_DESCRIPTION)	"Bei Bet&auml;tigung des Schaltkontaktes wird die Anzeige der Statusanzeige ausgeschaltet."
...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
	...
	# TODO status mittels catch abfangen..... 
	set status [xmlrpc $url getValue [list string $receiver_address] STATE]
