...
set PROFILE_4(LONG_MAX_TIME_FIRST_DIR)	0.5
set PROFILE_4(LONG_MULTIEXECUTE)	1
set PROFILE_4(LONG_OFFDELAY_TIME)	{0 range 0.0 - 111600.0}
set PROFILE_4(LONG_OFF_LEVEL)		0
set PROFILE_4(LONG_OFF_TIME)		{111600 range 0.0 - 111600.0}
...
set PROFILE_4(SHORT_OFFDELAY_TIME)	{0 range 0.0 - 111600.0}
set PROFILE_4(SHORT_OFF_LEVEL)		0
set PROFILE_4(SHORT_OFF_TIME)		{111600 range 0.0 - 111600.0}
