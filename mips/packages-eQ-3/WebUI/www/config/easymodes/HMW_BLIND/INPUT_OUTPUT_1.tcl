...
set PROFILE_1(LONG_DRIVING_MODE)	3
...
set PROFILE_2(LONG_DRIVING_MODE)	3
...
set PROFILE_2(LONG_JT_REFOFF)		6
set PROFILE_2(LONG_JT_REFON)		3
set PROFILE_2(LONG_MAX_TIME_FIRST_DIR)	0.500000
set PROFILE_2(LONG_MULTIEXECUTE)	1
set PROFILE_2(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_2(LONG_OFF_TIME_MODE)	1
...
set PROFILE_2(LONG_ON_TIME)			16383000.000000
set PROFILE_2(LONG_TOGGLE_USE)		1
...
set PROFILE_4(LONG_DRIVING_MODE)	3
set PROFILE_4(LONG_JT_OFF)			0
set PROFILE_4(LONG_JT_OFFDELAY)		0
set PROFILE_4(LONG_JT_ON)			0
set PROFILE_4(LONG_JT_ONDELAY)		1
set PROFILE_4(LONG_JT_RAMPOFF)		7
set PROFILE_4(LONG_JT_RAMPON)		2
set PROFILE_4(LONG_JT_REFOFF)		7
set PROFILE_4(LONG_JT_REFON)		2
set PROFILE_4(LONG_MAX_TIME_FIRST_DIR)	0.500000
set PROFILE_4(LONG_MULTIEXECUTE)	1
set PROFILE_4(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_4(LONG_OFF_TIME_MODE)	1
...
set PROFILE_4(LONG_ON_TIME)			16383000.000000
set PROFILE_4(LONG_TOGGLE_USE)		1
...
set SUBSET_1(LONG_JT_OFF)			0
set SUBSET_1(LONG_JT_OFFDELAY)		0
set SUBSET_1(LONG_JT_ON)			0
set SUBSET_1(LONG_JT_ONDELAY)		1
set SUBSET_1(LONG_JT_RAMPOFF)		7
set SUBSET_1(LONG_JT_RAMPON)		2
set SUBSET_1(LONG_JT_REFOFF)		7
set SUBSET_1(LONG_JT_REFON)			2

#set SUBSET_2(NAME)					"Runtergefahren"
set SUBSET_2(NAME)					"\${subset_2}"
set SUBSET_2(SUBSET_OPTION_VALUE)	2
set SUBSET_2(LONG_JT_OFF)			4
set SUBSET_2(LONG_JT_OFFDELAY)		5
set SUBSET_2(LONG_JT_ON)			4
set SUBSET_2(LONG_JT_ONDELAY)		4
set SUBSET_2(LONG_JT_RAMPOFF)		6
set SUBSET_2(LONG_JT_RAMPON)		3
set SUBSET_2(LONG_JT_REFOFF)		6
set SUBSET_2(LONG_JT_REFON)			3
...
set SUBSET_3(LONG_JT_OFF)			0
set SUBSET_3(LONG_JT_OFFDELAY)		5
set SUBSET_3(LONG_JT_ON)			4
set SUBSET_3(LONG_JT_ONDELAY)		1
set SUBSET_3(LONG_JT_RAMPOFF)		7
set SUBSET_3(LONG_JT_RAMPON)		3
set SUBSET_3(LONG_JT_REFOFF)		7
set SUBSET_3(LONG_JT_REFON)			3
...
#	die Texte der Platzhalter einlesen > _sender(TYPE)_1 = der Sender ist als Taster geschaltet.
...
#4
	...
	append HTML_PARAMS(separate_$prn) "<tr><td>\${UP_TIME}</td><td>"
	option LENGTH_OF_STAY
	append HTML_PARAMS(separate_$prn) [get_ComboBox options SHORT_ON_TIME|LONG_ON_TIME separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_ON_TIME "onclick=\"SwitchOption('separate_${special_input_id}_$prn\_2', 'separate_${special_input_id}_$prn\_1', \$('${special_input_id}_profiles'),2,'${special_input_id}');\" onchange=\"ActivateFreeTime(\$('${special_input_id}_profiles'),$pref);\""]
	EnterTime_h_m_s $prn $pref ${special_input_id} ps_descr SHORT_ON_TIME
	append HTML_PARAMS(separate_$prn) "</td></tr>"
	...
	append HTML_PARAMS(separate_$prn) "<tr><td>\${DOWN_TIME}</td><td>"
	option LENGTH_OF_STAY
	append HTML_PARAMS(separate_$prn) [get_ComboBox options SHORT_OFF_TIME|LONG_OFF_TIME separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_OFF_TIME "onclick=\"SwitchOption('separate_${special_input_id}_$prn\_1', 'separate_${special_input_id}_$prn\_2',  \$('${special_input_id}_profiles'),1,'${special_input_id}');\" onchange=\"ActivateFreeTime(\$('${special_input_id}_profiles'),$pref);\""]
	EnterTime_h_m_s $prn $pref ${special_input_id} ps_descr SHORT_OFF_TIME
	
	if {$cur_profile == $prn} then {
		append HTML_PARAMS(separate_$prn) "</td></tr>"
		append HTML_PARAMS(separate_$prn) "<tr><td>\${UP_LEVEL}</td><td>"
		append HTML_PARAMS(separate_$prn) "<input type=\"text\" id=\"separate_${special_input_id}_$prn\_3_temp\" name=\"SHORT_ON_LEVEL\" value=\"[expr $ps(SHORT_ON_LEVEL) * 100]\" onkeyup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_3_temp', 'separate_${special_input_id}_$prn\_3', parseInt(0), parseInt(100), parseFloat(0.01));\" onmouseup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_3_temp', 'separate_${special_input_id}_$prn\_3', parseInt(0), parseInt(100), parseFloat(0.01));\" onblur=\"ProofAndSetValue('separate_${special_input_id}_$prn\_3_temp', 'separate_${special_input_id}_$prn\_3', parseInt(0), parseInt(100), parseFloat(0.01));\" />\%<br />"
		...
		append HTML_PARAMS(separate_$prn) "<input type=\"text\" id=\"separate_${special_input_id}_$prn\_8_temp\" name=\"SHORT_OFF_LEVEL\" value=\"[expr $ps(SHORT_OFF_LEVEL) * 100]\" onkeyup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_8_temp', 'separate_${special_input_id}_$prn\_8', parseInt(0), parseInt(100), parseFloat(0.01));\" onmouseup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_8_temp', 'separate_${special_input_id}_$prn\_8', parseInt(0), parseInt(100), parseFloat(0.01));\" onblur=\"ProofAndSetValue('separate_${special_input_id}_$prn\_8_temp', 'separate_${special_input_id}_$prn\_8', parseInt(0), parseInt(100), parseFloat(0.01));\" />\%"
		...
		append HTML_PARAMS(separate_$prn) "</td></tr>"
		append HTML_PARAMS(separate_$prn) "<tr><td>\${UP_LEVEL}</td><td>"
		append HTML_PARAMS(separate_$prn) "<input type=\"text\" id=\"separate_${special_input_id}_$prn\_3_temp\" name=\"SHORT_ON_LEVEL\" value=\"[expr $PROFILE_4(SHORT_ON_LEVEL) * 100]\" onkeyup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_3_temp', 'separate_${special_input_id}_$prn\_3', parseInt(0), parseInt(100), parseFloat(0.01));\" onmouseup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_3_temp', 'separate_${special_input_id}_$prn\_3', parseInt(0), parseInt(100), parseFloat(0.01));\" onblur=\"ProofAndSetValue('separate_${special_input_id}_$prn\_3_temp', 'separate_${special_input_id}_$prn\_3', parseInt(0), parseInt(100), parseFloat(0.01));\" />\%<br />"
		...
		append HTML_PARAMS(separate_$prn) "</td></tr>"
		append HTML_PARAMS(separate_$prn) "<tr><td>\${DOWN_LEVEL}</td><td>"
		append HTML_PARAMS(separate_$prn) "<input type=\"text\" id=\"separate_${special_input_id}_$prn\_8_temp\" name=\"SHORT_OFF_LEVEL\" value=\"[expr $PROFILE_4(SHORT_OFF_LEVEL) * 100]\" onkeyup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_8_temp', 'separate_${special_input_id}_$prn\_8', parseInt(0), parseInt(100), parseFloat(0.01));\" onmouseup=\"ProofAndSetValue('separate_${special_input_id}_$prn\_8_temp', 'separate_${special_input_id}_$prn\_8', parseInt(0), parseInt(100), parseFloat(0.01));\" onblur=\"ProofAndSetValue('separate_${special_input_id}_$prn\_8_temp', 'separate_${special_input_id}_$prn\_8', parseInt(0), parseInt(100), parseFloat(0.01));\" />\%"
