...
source [file join $env(DOCUMENT_ROOT) config/easymodes/HMW_SWITCH/mapping/INPUT_OUTPUT_1_map.tcl]
...
set PROFILE_1(LONG_TOGGLE_USE)		0
...
set PROFILE_1(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck wird der Schalter f&uuml;r die gew&uuml;nschte Zeit je nach aktuellem Zustand ein- oder ausgeschaltet (Togglefunktion). Ist eine Ein- oder Ausschaltverz&ouml;gerungszeit eingestellt, so wird der Schalter erst nach Ablauf dieser Zeit ein- bzw. ausgeschaltet."
set PROFILE_1(UI_TEMPLATE)		$PROFILE_1(UI_DESCRIPTION)
set PROFILE_1(UI_HINT)	1

set PROFILE_2(LONG_ACTION_TYPE)		1
set PROFILE_2(LONG_JT_OFF)			0
set PROFILE_2(LONG_JT_OFFDELAY)		1
set PROFILE_2(LONG_JT_ON)			1
set PROFILE_2(LONG_JT_ONDELAY)		1
...
set PROFILE_2(LONG_ON_TIME)			300.000000
set PROFILE_2(LONG_ON_TIME_MODE)	1
set PROFILE_2(LONG_TOGGLE_USE)		0
...
set PROFILE_2(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck schaltet der Schalter f&uuml;r die gew&uuml;nschte Zeit ein. Wird der Taster w&auml;hrend der EIN-Phase nochmal bet&auml;tigt, beginnt die Zeitz&auml;hlung von vorne."
set PROFILE_2(UI_TEMPLATE)		$PROFILE_2(UI_DESCRIPTION)
set PROFILE_2(UI_HINT)	2

set PROFILE_3(LONG_ACTION_TYPE)		1
set PROFILE_3(LONG_JT_OFF)			0
set PROFILE_3(LONG_JT_OFFDELAY)		1
set PROFILE_3(LONG_JT_ON)			1
...
set PROFILE_3(LONG_TOGGLE_USE)		0
...
set PROFILE_3(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck wird der Schalter f&uuml;r die gew&uuml;nschte Zeit eingeschaltet. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so wird der Schalter erst nach Ablauf dieser Zeit eingeschaltet."
set PROFILE_3(UI_TEMPLATE)		$PROFILE_3(UI_DESCRIPTION)
set PROFILE_3(UI_HINT)	3

set PROFILE_4(LONG_ACTION_TYPE)		1
set PROFILE_4(LONG_JT_OFF)			3
set PROFILE_4(LONG_JT_OFFDELAY)		3
set PROFILE_4(LONG_JT_ON)			2
set PROFILE_4(LONG_JT_ONDELAY)		3
...
set PROFILE_4(LONG_TOGGLE_USE)		0
...
set PROFILE_4(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck wird der Schalter f&uuml;r die gew&uuml;nschte Zeit ausgeschaltet. Ist eine Ausschaltverz&ouml;gerungszeit eingestellt, so wird der Schalter erst nach Ablauf dieser Zeit ausgeschaltet."
