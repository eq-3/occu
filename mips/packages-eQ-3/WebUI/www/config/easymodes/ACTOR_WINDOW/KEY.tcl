...
set PROFILES_MAP(3)   "\${toggleWindow}"
...
set PROFILE_1(SHORT_MULTIEXECUTE)   1
...
set PROFILE_2(SHORT_MULTIEXECUTE)   1
...
set PROFILE_3(SHORT_CT_RAMPON)      1
set PROFILE_3(SHORT_CT_OFFDELAY)    2
set PROFILE_3(SHORT_CT_ONDELAY)     1
...
set PROFILE_3(SHORT_MULTIEXECUTE)   1
...
set PROFILE_4(SHORT_COND_VALUE_LO)  1
set PROFILE_4(SHORT_COND_VALUE_HI)  1
...
set PROFILE_4(SHORT_MULTIEXECUTE)   1
...
set PROFILE_5(SHORT_CT_RAMPOFF)     2
set PROFILE_5(SHORT_CT_RAMPON)      1
...
set PROFILE_6(SHORT_CT_RAMPOFF)     2
set PROFILE_6(SHORT_CT_RAMPON)      1
set PROFILE_6(SHORT_CT_OFFDELAY)    2
set PROFILE_6(SHORT_CT_ONDELAY)     1
set PROFILE_6(SHORT_CT_OFF)         2
set PROFILE_6(SHORT_CT_ON)          1
...
set PROFILE_6(SHORT_MULTIEXECUTE)   1
...
set PROFILE_6(SHORT_JT_RAMPOFF)     3
...
set PROFILE_7(SHORT_CT_RAMPOFF)     2
set PROFILE_7(SHORT_CT_RAMPON)      1
set PROFILE_7(SHORT_CT_OFFDELAY)    2
set PROFILE_7(SHORT_CT_ONDELAY)     1
set PROFILE_7(SHORT_CT_OFF)         2
set PROFILE_7(SHORT_CT_ON)          1
...
set PROFILE_7(SHORT_MULTIEXECUTE)   1
...
set PROFILE_7(SHORT_JT_RAMPOFF)     3
...
set PROFILE_8(SHORT_CT_RAMPOFF)     2
set PROFILE_8(SHORT_CT_RAMPON)      1
set PROFILE_8(SHORT_CT_OFFDELAY)    2
set PROFILE_8(SHORT_CT_ONDELAY)     1
set PROFILE_8(SHORT_CT_OFF)         2
set PROFILE_8(SHORT_CT_ON)          1
...
set PROFILE_8(SHORT_MULTIEXECUTE)   1
...
set PROFILE_8(SHORT_JT_RAMPOFF)     3
...
set PROFILE_9(SHORT_CT_RAMPOFF)     2
set PROFILE_9(SHORT_CT_RAMPON)      1
set PROFILE_9(SHORT_CT_OFFDELAY)    2
set PROFILE_9(SHORT_CT_ONDELAY)     1
set PROFILE_9(SHORT_CT_OFF)         2
set PROFILE_9(SHORT_CT_ON)          1
...
set PROFILE_9(SHORT_MULTIEXECUTE)   1
...
set PROFILE_9(SHORT_JT_RAMPOFF)     3
