...
set PROFILE_1(LONG_ON_TIME)			16383000.000000
set PROFILE_1(LONG_ON_TIME_MODE)	0
set PROFILE_1(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_1(LONG_RAMPON_TIME)		0.500000
...
set PROFILE_1(UI_DESCRIPTION)	"Mit einem kurzen Tastendruck wird das Licht auf der eingestellten Helligkeit eingeschaltet. Mit einem langen Tastendruck wird das Licht hoch gedimmt."
set PROFILE_1(UI_TEMPLATE)		$PROFILE_1(UI_DESCRIPTION)
set PROFILE_1(UI_HINT)	1

set PROFILE_2(LONG_ACTION_TYPE)		5
set PROFILE_2(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_2(LONG_DIM_MIN_LEVEL)	0.000000
...
set PROFILE_2(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_2(LONG_OFF_LEVEL)		0.000000
set PROFILE_2(LONG_OFF_TIME)		16383000.000000
set PROFILE_2(LONG_OFF_TIME_MODE)	0
set PROFILE_2(LONG_ONDELAY_MODE)	0
set PROFILE_2(LONG_ONDELAY_TIME)	0.000000
set PROFILE_2(LONG_ON_LEVEL)		1.000000
set PROFILE_2(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_2(LONG_ON_TIME)			1.000000
set PROFILE_2(LONG_ON_TIME_MODE)	1
set PROFILE_2(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_2(LONG_RAMPON_TIME)		0.500000
...
set PROFILE_2(UI_DESCRIPTION)	"Mit einem kurzen Tastendruck wird das Licht ausgeschaltet. Mit einem langen Tastendruck wird das Licht herunter gedimmt."
set PROFILE_2(UI_TEMPLATE)		$PROFILE_2(UI_DESCRIPTION)
set PROFILE_2(UI_HINT)	2

set PROFILE_3(LONG_ACTION_TYPE)		6
set PROFILE_3(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_3(LONG_DIM_MIN_LEVEL)	0.000000
...
set PROFILE_3(LONG_JT_ONDELAY)		1
set PROFILE_3(LONG_JT_RAMPOFF)		5
set PROFILE_3(LONG_JT_RAMPON)		2
set PROFILE_3(LONG_MULTIEXECUTE)	1
set PROFILE_3(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_3(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_3(LONG_OFF_LEVEL)		0.000000
set PROFILE_3(LONG_OFF_TIME)		16383000.000000
set PROFILE_3(LONG_OFF_TIME_MODE)	0
set PROFILE_3(LONG_ONDELAY_MODE)	0
set PROFILE_3(LONG_ONDELAY_TIME)	0.000000
set PROFILE_3(LONG_ON_LEVEL)		1.000000
set PROFILE_3(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_3(LONG_ON_TIME)			16383000.000000
set PROFILE_3(LONG_ON_TIME_MODE)	0
set PROFILE_3(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_3(LONG_RAMPON_TIME)		0.500000
...
set PROFILE_3(UI_DESCRIPTION)	"Mit einem kurzen Tastendruck wechselt das Licht zwischen der eingestellten Helligkeit und &quot;Aus&quot;. Mit einem langen Tastendruck wird das Licht abwechselnd hoch und herunter gedimmt."
...
set PROFILE_4(LONG_JT_OFF)			0
set PROFILE_4(LONG_JT_OFFDELAY)		1
set PROFILE_4(LONG_JT_ON)			1
set PROFILE_4(LONG_JT_ONDELAY)		1
set PROFILE_4(LONG_JT_RAMPOFF)		1
set PROFILE_4(LONG_JT_RAMPON)		6
set PROFILE_4(LONG_MULTIEXECUTE)	1
set PROFILE_4(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_4(LONG_OFFDELAY_TIME)	20.000000
set PROFILE_4(LONG_OFF_LEVEL)		0.000000
set PROFILE_4(LONG_OFF_TIME)		16383000.000000
set PROFILE_4(LONG_OFF_TIME_MODE)	0
set PROFILE_4(LONG_ONDELAY_MODE)	0
set PROFILE_4(LONG_ONDELAY_TIME)	0.000000
set PROFILE_4(LONG_ON_LEVEL)		0.900000
set PROFILE_4(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_4(LONG_ON_TIME)			120.000000
set PROFILE_4(LONG_ON_TIME_MODE)	1
set PROFILE_4(LONG_RAMPOFF_TIME)	20.000000
set PROFILE_4(LONG_RAMPON_TIME)		0.500000
...
set PROFILE_4(UI_DESCRIPTION)	"Das Licht wird durch kurzen oder langen Tastendruck f&uuml;r die eingestellte Zeit eingeschaltet. In der Ausschaltverz&ouml;gerung wird der Pegel zur Vorwarnung leicht abgesenkt, um anschlie&szlig;end langsam bis auf &quot;Aus&quot; herunter zu dimmen."
set PROFILE_4(UI_TEMPLATE)		$PROFILE_4(UI_DESCRIPTION)
set PROFILE_4(UI_HINT)	4

set PROFILE_5(LONG_ACTION_TYPE)		6
set PROFILE_5(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_5(LONG_DIM_MIN_LEVEL)	0.000000
set PROFILE_5(LONG_DIM_STEP)		0.050000
set PROFILE_5(LONG_JT_OFF)			0
set PROFILE_5(LONG_JT_OFFDELAY)		1
set PROFILE_5(LONG_JT_ON)			1
set PROFILE_5(LONG_JT_ONDELAY)		1
set PROFILE_5(LONG_JT_RAMPOFF)		1
set PROFILE_5(LONG_JT_RAMPON)		2
set PROFILE_5(LONG_MULTIEXECUTE)	1
set PROFILE_5(LONG_OFFDELAY_STEP)	0.000000
set PROFILE_5(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_5(LONG_OFF_LEVEL)		0.000000
set PROFILE_5(LONG_OFF_TIME)		16383000.000000
set PROFILE_5(LONG_OFF_TIME_MODE)	0
set PROFILE_5(LONG_ONDELAY_MODE)	0
set PROFILE_5(LONG_ONDELAY_TIME)	0.000000
set PROFILE_5(LONG_ON_LEVEL)		0.500000
set PROFILE_5(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_5(LONG_ON_TIME)			1800.000000
set PROFILE_5(LONG_ON_TIME_MODE)	1
set PROFILE_5(LONG_RAMPOFF_TIME)	1800.000000
set PROFILE_5(LONG_RAMPON_TIME)		0.500000
set PROFILE_5(LONG_RAMP_START_STEP)	0.000000
...
set PROFILE_5(UI_DESCRIPTION)	"Mit einem kurzen Tastendruck wird das Licht auf der eingestellten Helligkeit eingeschaltet und nach der eingestellten Zeit langsam auf &quot;Aus&quot; herunter gedimmt. Mit einem langen Tastendruck wird das Licht abwechselnd hoch und herunter gedimmt."
set PROFILE_5(UI_TEMPLATE)		$PROFILE_5(UI_DESCRIPTION)
set PROFILE_5(UI_HINT)	5

set PROFILE_6(LONG_ACTION_TYPE)		1
set PROFILE_6(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_6(LONG_DIM_MIN_LEVEL)	0.000000
set PROFILE_6(LONG_DIM_STEP)		0.050000
set PROFILE_6(LONG_JT_OFF)			0
set PROFILE_6(LONG_JT_OFFDELAY)		0
set PROFILE_6(LONG_JT_ON)			3
set PROFILE_6(LONG_JT_ONDELAY)		3
set PROFILE_6(LONG_JT_RAMPOFF)		0
set PROFILE_6(LONG_JT_RAMPON)		3
set PROFILE_6(LONG_MULTIEXECUTE)	0
set PROFILE_6(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_6(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_6(LONG_OFF_LEVEL)		0.000000
set PROFILE_6(LONG_OFF_TIME)		1.000000
set PROFILE_6(LONG_OFF_TIME_MODE)	0
set PROFILE_6(LONG_ONDELAY_MODE)	0
set PROFILE_6(LONG_ONDELAY_TIME)	0.000000
set PROFILE_6(LONG_ON_LEVEL)		1.000000
set PROFILE_6(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_6(LONG_ON_TIME)			1.000000
set PROFILE_6(LONG_ON_TIME_MODE)	0
set PROFILE_6(LONG_RAMPOFF_TIME)	0.000000
set PROFILE_6(LONG_RAMPON_TIME)		0.000000
...
set PROFILE_6(SHORT_JT_OFFDELAY)	0
set PROFILE_6(SHORT_JT_ON)			3
set PROFILE_6(SHORT_JT_ONDELAY)		3
set PROFILE_6(SHORT_JT_RAMPOFF)		0
...
set PROFILE_6(SHORT_OFF_TIME)		1.000000
set PROFILE_6(SHORT_OFF_TIME_MODE)	0
set PROFILE_6(SHORT_ONDELAY_MODE)	0
set PROFILE_6(SHORT_ONDELAY_TIME)	0.000000
set PROFILE_6(SHORT_ON_LEVEL)		1.000000
set PROFILE_6(SHORT_ON_MIN_LEVEL)	0.100000
set PROFILE_6(SHORT_ON_TIME)		1.000000
set PROFILE_6(SHORT_ON_TIME_MODE)	0
set PROFILE_6(SHORT_RAMPOFF_TIME)	0.000000
set PROFILE_6(SHORT_RAMPON_TIME)	0.000000
set PROFILE_6(SHORT_RAMP_START_STEP)	0.000000
...
set PROFILE_7(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_7(LONG_DIM_MIN_LEVEL)	0.000000
set PROFILE_7(LONG_DIM_STEP)		0.050000
set PROFILE_7(LONG_JT_OFF)			0
set PROFILE_7(LONG_JT_OFFDELAY)		4
set PROFILE_7(LONG_JT_ON)			3
set PROFILE_7(LONG_JT_ONDELAY)		1
set PROFILE_7(LONG_JT_RAMPOFF)		5
set PROFILE_7(LONG_JT_RAMPON)		2
set PROFILE_7(LONG_MULTIEXECUTE)	1
set PROFILE_7(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_7(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_7(LONG_OFF_LEVEL)		0.000000
set PROFILE_7(LONG_OFF_TIME)		16383000.000000
set PROFILE_7(LONG_OFF_TIME_MODE)	0
set PROFILE_7(LONG_ONDELAY_MODE)	0
set PROFILE_7(LONG_ONDELAY_TIME)	0.000000
set PROFILE_7(LONG_ON_LEVEL)		0.800000
set PROFILE_7(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_7(LONG_ON_TIME)			16383000.000000
set PROFILE_7(LONG_ON_TIME_MODE)	0
set PROFILE_7(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_7(LONG_RAMPON_TIME)		60.000000
set PROFILE_7(LONG_RAMP_START_STEP)	0.000000
...
set PROFILE_7(SHORT_JT_OFFDELAY)	4
set PROFILE_7(SHORT_JT_ON)			3
set PROFILE_7(SHORT_JT_ONDELAY)		1
set PROFILE_7(SHORT_JT_RAMPOFF)		5
set PROFILE_7(SHORT_JT_RAMPON)		2
...
set PROFILE_7(SHORT_OFF_TIME)		16383000.000000
set PROFILE_7(SHORT_OFF_TIME_MODE)	0
set PROFILE_7(SHORT_ONDELAY_MODE)	0
set PROFILE_7(SHORT_ONDELAY_TIME)	0.000000
set PROFILE_7(SHORT_ON_LEVEL)		0.800000
set PROFILE_7(SHORT_ON_MIN_LEVEL)	0.100000
set PROFILE_7(SHORT_ON_TIME)		16383000.000000
set PROFILE_7(SHORT_ON_TIME_MODE)	0
set PROFILE_7(SHORT_RAMPOFF_TIME)	0.500000
set PROFILE_7(SHORT_RAMPON_TIME)	60.000000
set PROFILE_7(SHORT_RAMP_START_STEP)	0.050000
set PROFILE_7(UI_DESCRIPTION)	"Mit einem kurzen Tastendruck wird das Licht langsam auf die eingestellten Helligkeit hoch gedimmt. Mit einem langen Tastendruck wird das Licht abwechselnd hoch und herunter gedimmt."
set PROFILE_7(UI_TEMPLATE)		$PROFILE_7(UI_DESCRIPTION)
set PROFILE_7(UI_HINT)	7

set PROFILE_8(LONG_ACTION_TYPE)		1
set PROFILE_8(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_8(LONG_DIM_MIN_LEVEL)	0.000000
set PROFILE_8(LONG_DIM_STEP)		0.050000
set PROFILE_8(LONG_JT_OFF)			0
set PROFILE_8(LONG_JT_OFFDELAY)		1
set PROFILE_8(LONG_JT_ON)			1
set PROFILE_8(LONG_JT_ONDELAY)		1
set PROFILE_8(LONG_JT_RAMPOFF)		1
set PROFILE_8(LONG_JT_RAMPON)		2
set PROFILE_8(LONG_MULTIEXECUTE)	0
set PROFILE_8(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_8(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_8(LONG_OFF_LEVEL)		0.000000
set PROFILE_8(LONG_OFF_TIME)		16383000.000000
set PROFILE_8(LONG_OFF_TIME_MODE)	0
set PROFILE_8(LONG_ONDELAY_MODE)	0
set PROFILE_8(LONG_ONDELAY_TIME)	0.000000
set PROFILE_8(LONG_ON_LEVEL)		1.000000
set PROFILE_8(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_8(LONG_ON_TIME)			16383000.000000
set PROFILE_8(LONG_ON_TIME_MODE)	0
set PROFILE_8(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_8(LONG_RAMPON_TIME)		0.500000
...
set PROFILE_8(SHORT_DIM_STEP)		0.050000
set PROFILE_8(SHORT_JT_OFF)			0
set PROFILE_8(SHORT_JT_OFFDELAY)	1
set PROFILE_8(SHORT_JT_ON)			1
set PROFILE_8(SHORT_JT_ONDELAY)		1
set PROFILE_8(SHORT_JT_RAMPOFF)		1
set PROFILE_8(SHORT_JT_RAMPON)		2
set PROFILE_8(SHORT_OFFDELAY_STEP)	0.050000
set PROFILE_8(SHORT_OFFDELAY_TIME)	0.000000
set PROFILE_8(SHORT_OFF_LEVEL)		0.000000
set PROFILE_8(SHORT_OFF_TIME)		16383000.000000
set PROFILE_8(SHORT_OFF_TIME_MODE)	0
set PROFILE_8(SHORT_ONDELAY_MODE)	0
set PROFILE_8(SHORT_ONDELAY_TIME)	0.000000
set PROFILE_8(SHORT_ON_LEVEL)		1.000000
set PROFILE_8(SHORT_ON_MIN_LEVEL)	0.100000
set PROFILE_8(SHORT_ON_TIME)		16383000.000000
set PROFILE_8(SHORT_ON_TIME_MODE)	0
set PROFILE_8(SHORT_RAMPOFF_TIME)	0.500000
set PROFILE_8(SHORT_RAMPON_TIME)	0.500000
set PROFILE_8(SHORT_RAMP_START_STEP)	0.050000
set PROFILE_8(UI_DESCRIPTION)	"Das Licht wird durch kurzen oder langen Tastendruck auf der eingestellten Helligkeit eingeschaltet."
...
set PROFILE_9(LONG_JT_OFF)			3
set PROFILE_9(LONG_JT_OFFDELAY)		5
set PROFILE_9(LONG_JT_ON)			3
set PROFILE_9(LONG_JT_ONDELAY)		3
set PROFILE_9(LONG_JT_RAMPOFF)		5
...
set PROFILE_9(LONG_OFF_TIME)		16383000.000000
set PROFILE_9(LONG_OFF_TIME_MODE)	0
set PROFILE_9(LONG_ONDELAY_MODE)	0
set PROFILE_9(LONG_ONDELAY_TIME)	0.000000
set PROFILE_9(LONG_ON_LEVEL)		1.000000
set PROFILE_9(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_9(LONG_ON_TIME)			16383000.000000
...
set PROFILE_9(SHORT_JT_OFF)			3
set PROFILE_9(SHORT_JT_OFFDELAY)	4
set PROFILE_9(SHORT_JT_ON)			3
set PROFILE_9(SHORT_JT_ONDELAY)		3
set PROFILE_9(SHORT_JT_RAMPOFF)		5
set PROFILE_9(SHORT_JT_RAMPON)		3
set PROFILE_9(SHORT_OFFDELAY_STEP)	0.050000
set PROFILE_9(SHORT_OFFDELAY_TIME)	0.000000
set PROFILE_9(SHORT_OFF_LEVEL)		0.000000
set PROFILE_9(SHORT_OFF_TIME)		16383000.000000
set PROFILE_9(SHORT_OFF_TIME_MODE)	0
set PROFILE_9(SHORT_ONDELAY_MODE)	0
set PROFILE_9(SHORT_ONDELAY_TIME)	0.000000
set PROFILE_9(SHORT_ON_LEVEL)		1.000000
set PROFILE_9(SHORT_ON_MIN_LEVEL)	0.100000
set PROFILE_9(SHORT_ON_TIME)		16383000.000000
...
set PROFILE_10(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_10(LONG_DIM_MIN_LEVEL)	0.000000
set PROFILE_10(LONG_DIM_STEP)		0.050000
set PROFILE_10(LONG_JT_OFF)			0
set PROFILE_10(LONG_JT_OFFDELAY)	1
set PROFILE_10(LONG_JT_ON)			1
set PROFILE_10(LONG_JT_ONDELAY)		1
set PROFILE_10(LONG_JT_RAMPOFF)		1
set PROFILE_10(LONG_JT_RAMPON)		2
set PROFILE_10(LONG_MULTIEXECUTE)	1
set PROFILE_10(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_10(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_10(LONG_OFF_LEVEL)		0.000000
set PROFILE_10(LONG_OFF_TIME)		16383000.000000
set PROFILE_10(LONG_OFF_TIME_MODE)	0
set PROFILE_10(LONG_ONDELAY_MODE)	0
set PROFILE_10(LONG_ONDELAY_TIME)	0.000000
set PROFILE_10(LONG_ON_LEVEL)		1.000000
set PROFILE_10(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_10(LONG_ON_TIME)		16383000.000000
set PROFILE_10(LONG_ON_TIME_MODE)	0
set PROFILE_10(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_10(LONG_RAMPON_TIME)	0.500000
set PROFILE_10(LONG_RAMP_START_STEP)	0.050000
set PROFILE_10(SHORT_ACTION_TYPE)	4
set PROFILE_10(SHORT_DIM_MAX_LEVEL)	1.000000
set PROFILE_10(SHORT_DIM_MIN_LEVEL)	0.000000
set PROFILE_10(SHORT_DIM_STEP)		0.050000
set PROFILE_10(SHORT_JT_OFF)		0
set PROFILE_10(SHORT_JT_OFFDELAY)	1
set PROFILE_10(SHORT_JT_ON)			1
set PROFILE_10(SHORT_JT_ONDELAY)	1
set PROFILE_10(SHORT_JT_RAMPOFF)	1
set PROFILE_10(SHORT_JT_RAMPON)		2
set PROFILE_10(SHORT_OFFDELAY_STEP)	0.050000
set PROFILE_10(SHORT_OFFDELAY_TIME)	0.000000
set PROFILE_10(SHORT_OFF_LEVEL)		0.000000
set PROFILE_10(SHORT_OFF_TIME)		16383000.000000
set PROFILE_10(SHORT_OFF_TIME_MODE)	0
set PROFILE_10(SHORT_ONDELAY_MODE)	0
set PROFILE_10(SHORT_ONDELAY_TIME)	0.000000
set PROFILE_10(SHORT_ON_LEVEL)		1.000000
set PROFILE_10(SHORT_ON_MIN_LEVEL)	0.100000
set PROFILE_10(SHORT_ON_TIME)		16383000.000000
set PROFILE_10(SHORT_ON_TIME_MODE)	0
set PROFILE_10(SHORT_RAMPOFF_TIME)	0.500000
set PROFILE_10(SHORT_RAMPON_TIME)	0.500000
set PROFILE_10(SHORT_RAMP_START_STEP)	0.050000
set PROFILE_10(UI_DESCRIPTION)	"Das Licht wird durch kurzen oder langen Tastendruck hocn gedimmt."
set PROFILE_10(UI_TEMPLATE)		$PROFILE_10(UI_DESCRIPTION)
set PROFILE_10(UI_HINT)	10

set PROFILE_11(LONG_ACTION_TYPE)	5
set PROFILE_11(LONG_DIM_MAX_LEVEL)	1.000000
set PROFILE_11(LONG_DIM_MIN_LEVEL)	0.000000
set PROFILE_11(LONG_DIM_STEP)		0.050000
set PROFILE_11(LONG_JT_OFF)			3
set PROFILE_11(LONG_JT_OFFDELAY)	4
set PROFILE_11(LONG_JT_ON)			3
set PROFILE_11(LONG_JT_ONDELAY)		3
set PROFILE_11(LONG_JT_RAMPOFF)		5
set PROFILE_11(LONG_JT_RAMPON)		3
set PROFILE_11(LONG_MULTIEXECUTE)	1
set PROFILE_11(LONG_OFFDELAY_STEP)	0.050000
set PROFILE_11(LONG_OFFDELAY_TIME)	0.000000
set PROFILE_11(LONG_OFF_LEVEL)		0.000000
set PROFILE_11(LONG_OFF_TIME)		16383000.000000
set PROFILE_11(LONG_OFF_TIME_MODE)	0
set PROFILE_11(LONG_ONDELAY_MODE)	0
set PROFILE_11(LONG_ONDELAY_TIME)	0.000000
set PROFILE_11(LONG_ON_LEVEL)		1.000000
set PROFILE_11(LONG_ON_MIN_LEVEL)	0.100000
set PROFILE_11(LONG_ON_TIME)		1.000000
set PROFILE_11(LONG_ON_TIME_MODE)	1
set PROFILE_11(LONG_RAMPOFF_TIME)	0.500000
set PROFILE_11(LONG_RAMPON_TIME)	0.500000
set PROFILE_11(LONG_RAMP_START_STEP)	0.050000
set PROFILE_11(SHORT_ACTION_TYPE)	5
set PROFILE_11(SHORT_DIM_MAX_LEVEL)	1.000000
set PROFILE_11(SHORT_DIM_MIN_LEVEL)	0.000000
set PROFILE_11(SHORT_DIM_STEP)		0.050000
set PROFILE_11(SHORT_JT_OFF)		3
set PROFILE_11(SHORT_JT_OFFDELAY)	4
set PROFILE_11(SHORT_JT_ON)			3
set PROFILE_11(SHORT_JT_ONDELAY)	3
set PROFILE_11(SHORT_JT_RAMPOFF)	5
set PROFILE_11(SHORT_JT_RAMPON)		3
set PROFILE_11(SHORT_OFFDELAY_STEP)	0.050000
set PROFILE_11(SHORT_OFFDELAY_TIME)	0.000000
set PROFILE_11(SHORT_OFF_LEVEL)		0.000000
set PROFILE_11(SHORT_OFF_TIME)		16383000.000000
set PROFILE_11(SHORT_OFF_TIME_MODE)	0
set PROFILE_11(SHORT_ONDELAY_MODE)	0
set PROFILE_11(SHORT_ONDELAY_TIME)	0.000000
set PROFILE_11(SHORT_ON_LEVEL)		1.000000
set PROFILE_11(SHORT_ON_MIN_LEVEL)	0.100000
set PROFILE_11(SHORT_ON_TIME)		1.000000
set PROFILE_11(SHORT_ON_TIME_MODE)	1
set PROFILE_11(SHORT_RAMPOFF_TIME)	0.500000
set PROFILE_11(SHORT_RAMPON_TIME)	0.500000
set PROFILE_11(SHORT_RAMP_START_STEP)	0.050000
set PROFILE_11(UI_DESCRIPTION)	"Das Licht wird durch kurzen oder langen Tastendruck herunter gedimmt."
...
#	die Texte der Platzhalter einlesen > _sender(TYPE)_x = 0 der Sender ist als Schalter geschaltet, 1 der Sender ist als Taster geschaltet.
	puts "<script type=\"text/javascript\">getLangInfo('$dev_descr_sender(TYPE)_1', 'HMW_$dev_descr_receiver(TYPE)');</script>"
	set prn 0	
...
#3
	...
	append HTML_PARAMS(separate_$prn) "<tr><td>\${DIM_MIN_LEVEL}</td><td>"
	option DIM_OFFLEVEL
	append HTML_PARAMS(separate_$prn) [get_ComboBox options LONG_DIM_MIN_LEVEL separate_${special_input_id}_$prn\_$pref PROFILE_$prn LONG_DIM_MIN_LEVEL "onchange=\"ActivateFreePercent(\$('${special_input_id}_profiles'),$pref);\""]
	EnterPercent $prn $pref ${special_input_id} ps_descr LONG_DIM_MIN_LEVEL
	append HTML_PARAMS(separate_$prn) "</td></tr>"
...
#4	
	...
	append HTML_PARAMS(separate_$prn) "<tr><td>\${RAMPON_TIME}</td><td>"
	option RAMPTIME
	append HTML_PARAMS(separate_$prn) [get_ComboBox options SHORT_RAMPON_TIME|LONG_RAMPON_TIME separate_${special_input_id}_$prn\_$pref PROFILE_$prn SHORT_RAMPON_TIME "onchange=\"ActivateFreeTime(\$('${special_input_id}_profiles'),$pref);\""]
	EnterTime_h_m_s $prn $pref ${special_input_id} ps_descr SHORT_RAMPON_TIME
	append HTML_PARAMS(separate_$prn) "</td></tr>"
