...
set PROFILE_1(UI_DESCRIPTION)	"Mit einem kurzen oder langen Tastendruck blinkt die LED. Ist eine Einschaltverz&ouml;gerungszeit eingestellt, so wird die LED erst nach Ablauf dieser Zeit eingeschaltet."
