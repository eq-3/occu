...
source [file join $env(DOCUMENT_ROOT) config/easymodes/KEYMATIC/mapping/SHUTTER_CONTACT_map.tcl]

set PROFILES_MAP(0)	"\${expert}"
set PROFILES_MAP(1)	"\${door_lock}"
set PROFILES_MAP(2)	"\${door_lock_proof}"
...
set PROFILE_1(UI_DESCRIPTION)	"Nach dem Schlie&szlig;en der T&uuml;r wird sie unverz&uuml;glich verriegelt. Wenn der Magnetkontakt durch Sabotage entfernt wird....."
...
set PROFILE_2(UI_DESCRIPTION)	"Nach dem Schlie&szlig;en der T&uuml;r wird sie unverz&uuml;glich verriegelt."
...
set PROFILE_3(UI_DESCRIPTION)	"Der T&uuml;rkontakt ist au&szlig;er Betrieb."
