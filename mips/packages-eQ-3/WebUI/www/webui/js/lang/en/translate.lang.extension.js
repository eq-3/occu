jQuery.extend(true, langJSON, {
  "en": {
    ...
    "forcedUpdateHint" : "To ensure full operation of your new " + HMIdentifier.en.CCUFullName + ", please perform an update first. Therefore, please click the button 'Update' and install the files. The full range of functions will then be available for your " + HMIdentifier.en.CCUShortName + ".",
    ...
    "dialogNewDevicesBidCosRFLbl5c" : "<p><span class='CLASS21211' style='color:red'>Please note: </span>Not every BidCoS-RF device does support teaching-in via serial number.</p>",
