...
set PROFILE_1(SHORT_COND_VALUE_HI)  {100 range 100 - 255}
set PROFILE_1(SHORT_ON_TIME)        300
set PROFILE_1(SHORT_OFF_TIME)       111600
set PROFILE_1(SHORT_ONDELAY_TIME)   0
set PROFILE_1(SHORT_OFFDELAY_TIME)  20
set PROFILE_1(SHORT_ON_TIME_MODE)   1
set PROFILE_1(SHORT_OFF_TIME_MODE)  0
set PROFILE_1(SHORT_MULTIEXECUTE)   {0 1}
...
set PROFILE_2(SHORT_OFFDELAY_TIME)  20
