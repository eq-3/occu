...
set PROFILE_1(SHORT_JT_OFFDELAY)	{2 3}
set PROFILE_1(SHORT_JT_ONDELAY)		{4 1} 
set PROFILE_1(UI_DESCRIPTION)	"Bei Regen wird die Anzeige je nach Schaltrichtung gesetzt."
